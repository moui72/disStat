...
mtable <- with(na.omit(inter_item_timings),tapply(inter_reading, list("+GP"=GP_condition,"+Q"=Q_condition), mean))
...
```{r echo=FALSE}
boxplot(inter_reading ~ GP_condition*Q_condition, main="plain IRT", col=c("white","lightgray"),inter_item_timings,names=c("-GP -Q", "+GP -Q", "-GP +Q", "+GP +Q"))

boxplot(inter_reading.ln ~ GP_condition*Q_condition, main="natural log of IRT", col=c("white","lightgray"),inter_item_timings,names=c("-GP -Q", "+GP -Q", "-GP +Q", "+GP +Q"))
boxplot(inter_reading.inverse ~ GP_condition*Q_condition,main="inverse of IRT", col=c("white","lightgray"),inter_item_timings,names=c("-GP -Q", "+GP -Q", "-GP +Q", "+GP +Q"))
boxplot(inter_reading.log10 ~ GP_condition*Q_condition,main="common log of IRT", col=c("white","lightgray"),inter_item_timings,names=c("-GP -Q", "+GP -Q", "-GP +Q", "+GP +Q"))
boxplot(inter_reading.sqred ~ GP_condition*Q_condition,main="IRT squared", col=c("white","lightgray"),inter_item_timings,names=c("-GP -Q", "+GP -Q", "-GP +Q", "+GP +Q"))
