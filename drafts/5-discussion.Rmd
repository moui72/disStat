...
If the PP1 break is treated as the main indicator of the prosodic structure, then the larger difference across &plusmn;GP for declaratives (`r 27-14.8`%) than for interrogatives (`r 25.8-25.6`%) does indeed, though perhaps weakly, leave open the door for the @Bader1998-ts explanation of the intuition.
