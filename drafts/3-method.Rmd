...
Timings were collected by hand for `r 384*2` recordings (`r round(384*2 / nrow(meta) * 100,1)`%). Human measured timings were within 100ms of the VAD-measured timings in `??`%[^hh] of cases.
