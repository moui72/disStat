...
## Participants recruitment {#parti}
...
The informant was asked to report on whether or not she heard a prosodic boundary directly following the region labeled **OBJ**, and directly following the region labeled **PP1**. Note that throughout this dissertation, the word "break" is used interchangeably with the word "boundary" when referring to prosodic boundaries. It should be noted that the properties of prosodic boundaries vary, and break may not always be an appropriate descriptor, but the details of how prosodic boundaries are expressed fall outside the scope of the current work. The judgments elicited for this study rely solely on the coder's intuitive judgments, and it proves useful to employ the term "break" as a shortcut in some instances. There is a noteworthy difficulty in differentiating between hesitation and true prosodic boundaries. This matter is returned to in Section \@ref(hesi). Instruction regarding how to define prosodic boundary was provided to the coder by way of the following prose:
