...
```
In what follows, a detailed description of the considerations involved in creating this items is provided.
...
The preposition that headed PP1 was always one which was compatable with a goal argument: *in* (8), *on* (7), and in one case, *under*.
