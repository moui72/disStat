...
Models were also run for predicting break dominance. The full model predicting OBJ break dominance is shown in Table \@ref(tab:odom).
...
```{r interactionplot,fig.cap="Mean IRT by condition",fig.height=3.5,fig.pos="H"}
