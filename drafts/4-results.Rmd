...
Table \ref{tab:totByCond} shows the number of recordings included in analyses for each condition. If no items had been excluded, the expected number per bin would be `r 32*16/4*2`[^n].
