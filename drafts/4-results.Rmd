...
The best model for predicting the occurrence for the PP1 break was one where only PP2 status was included as a predictor. The chosen model was again better than the minimal model to a significant degree (AICMIN=855.6, AICBEST=629.6, $\chi^2$(1)=228.0, p < 0.001).
