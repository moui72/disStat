...
fitems[c(4:5)] %>% 
  kable(col.names=c("Version", "Text"), 
...
ppn[c("version","text")]%>% 
  kable(
    row.names=F,
    col.names=c("Version", "Text"),booktab=T,linesep = c("","\\addlinespace"),longtable=T) %>% 
  kable_styling(latex_options = c("hold_position","repeat_header"))
```
...
```{r bothbreaks2, fig.pos="!H", fig.height=3.5}
...
ggplot(adata,    
  ...
  ggtitle("Figure: Break pattern as a function of sentence type and Reading.")
