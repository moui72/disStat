...
Model `r dels.logi.attach.full <- glmer(lowAttach~Condition_Q*Condition_GP*Reading + (1+Condition_Q*Condition_GP*Reading | SID) + (1+Condition_Q*Condition_GP*Reading | IID)` fails to converge.
...
anova(models.logi.attach.full,models.logi.attach.noRint)
```